  ...
  return (
    <Fragment>
      ...
      <div className="ui  stackable grid margin-no">
        <div className="doubling ui segments bg-transparent border-none box-shadow-none">
          <div className=" doubling ui segment bg-transparent border-none box-shadow-none text-weight-medium">
            Recent Activities:
          </div>
          <div className=" doubling ui  horizontal segments bg-white recent-activity-container">
            <div className="doubling ui segment">
              <p>Pending Orders: </p>
              <ListView />
            </div>
            <div className=" doubling ui segment">
